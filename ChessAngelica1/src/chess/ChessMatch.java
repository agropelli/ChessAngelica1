...
import piecesofchess.Bishop;
import piecesofchess.King;
import piecesofchess.Knight;
import piecesofchess.Pawn;
import piecesofchess.Queen;
import piecesofchess.Rook;
...
public class ChessMatch {
    ...
    private boolean testCheck(Color color){
        ...
        List<Piece> oppontentPieces = pieceOnTheBoard.stream().filter( x -> ((ChessPiece)x).getColor()==opponent(color)).collect(Collectors.toList());
        for (Piece p: oppontentPieces){
